...
export function NotFoundPage() {
  return (
    <section className="grid gap-4" aria-labelledby="not-found-title">
      <p className="m-0 text-sm font-bold tracking-[0.08em] uppercase text-muted-foreground">
        404
      </p>
      <h1 id="not-found-title" className="m-0 text-4xl font-bold tracking-tight">
        Page not found
      </h1>
